...
ലഭ്യമായ കമാന്റുകളെപ്പറ്റി അറിയുവാൻ /help kick for know more commands.
...
*Main* commands available:
 ...
 - /settings: to set your group settings
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://youtu.be/W6CLKrehy6w")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/malayalammoviezgroup"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/KochuUpdates")],
                     [InlineKeyboardButton(text="🎬 MOVIE GROUP", url=")https://t.me/malayalammoviezgroup, InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
